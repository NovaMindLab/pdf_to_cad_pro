...
| 核心文档 | 内容概要 | 适用场景 |
| :--- | :--- | :--- |
| 🚀 **[v1.0.5 全量优化与架构发版指南](./v1.0.5_Optimization_and_Release.md)** | • 原生圆与圆弧拟合（CIRCLE/ARC）算法<br>• 24位 TrueColor + ACI 颜色双轨体系<br>• 根除文字重叠与真实角度倾斜旋转<br>• 画布浮动图层控制面板<br>• 排除重复打包使安装包瘦身 55MB、差分包瘦身 70% | 了解最新 v1.0.5 重大技术突破、实测对比与版本发布信息 |
